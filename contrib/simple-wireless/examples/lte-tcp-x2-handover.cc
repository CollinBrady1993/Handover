...
main (int argc, char *argv[])
{
  ...
  //ns3::SpectrumPropagationLossModel::SetNext  ( StringValue ("ns3::NakagamiPropagationLossModel") ) 
  //lteHelper->SetAttribute ("PathlossModel", StringValue ("ns3::NakagamiPropagationLossModel"));
  //lteHelper->SetEnbDeviceAttribute ("DlEarfcn", UintegerValue (1950)); // setting frequency, all band 4
  //lteHelper->SetEnbDeviceAttribute ("UlEarfcn", UintegerValue (19950));
  //lteHelper->SetUeDeviceAttribute ("DlEarfcn", UintegerValue (1950));
  //lteHelper->SetUeDeviceAttribute ("UlEarfcn", UintegerValue (19950));
  // there are more things we could set in the pathloss model but this is a demo right now.
  lteHelper->SetAttribute ("FadingModel", StringValue ("ns3::TraceFadingLossModel"));
  lteHelper->SetFadingModelAttribute ("TraceFilename", StringValue ("/home/collin/workspace/ns-3-ee-595-course/src/lte/model/fading-traces/fading_trace_EPA_3kmph.fad"));
